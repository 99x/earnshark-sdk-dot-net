# Contributing to earnshark-sdk-dot-net
...
Follow the project's repository link [earnshark-sdk-dot-net](https://github.com/99xt/earnshark-sdk-dot-net) to futher details.
...
*  Follow [CODE_OF_CONDUCT](https://github.com/99xt/earnshark-sdk-dot-net/blob/master/CODE_OF_CONDUCT.md)  before contributing.

### Suggesting Improvements

Improvements also same as GitHub Issues.

GitHub tracked Improvements as Issues.Firstly follow the [GitHub Issues](https://github.com/99xt/earnshark-sdk-dot-net/issues) to get a overrall idea on GitHub Issues.After you understood what is going on,then create a new Issue on the particular repository and provide necessary Information.
